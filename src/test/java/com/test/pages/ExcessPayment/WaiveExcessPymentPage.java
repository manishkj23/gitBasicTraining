...
public class WaiveExcessPymentPage {
    ...
    private final String pageHeading = "//*[@id=\"waiveExcess\"]//legend[contains(.,\"Waive Excess Payment\")]";
    ...
    public WaiveExcessPymentPage(BasePage base, SeleniumHelper seleniumHelper, CommonUtils commonUtils) {
        this.base = base;
