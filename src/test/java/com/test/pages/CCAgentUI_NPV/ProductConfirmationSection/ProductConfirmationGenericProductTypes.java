...
public class ProductConfirmationGenericProductTypes {
    ...
    public ProductConfirmationGenericProductTypes(BasePage base, SeleniumHelper seleniumHelper, CommonUtils commonUtils) {
        this.base = base;
