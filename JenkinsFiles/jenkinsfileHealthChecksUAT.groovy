...
pipeline {
    ...
    parameters {
        ...
        string(name: 'Tags', defaultValue: '@UAT-EnvironmentHealthCheck', description: 'Select Tags to run, eg: @HC')
        ...
        string(name:'EmailID',defaultValue: 'OrbitTestTeam@domesticandgeneral.com;a.bedford@pccsuk.com',description: 'Send Test Results in Email')
    }
    stages {
        stage('Checkout') {
            steps {
